...
public class ShooterTuningCommand extends CommandBase {
  private double m_setpoint, m_tolerance, m_conveyorSpeed;

  private final Shooter m_shooter;
  private final ShuffleboardTab m_myTab;
  private NetworkTableEntry m_kpEntry, m_kiEntry, m_kdEntry, m_kfEntry, m_spEntry, m_tolEntry,m_conveyorEntry;
  /**
  ...
  public ShooterTuningCommand( Shooter shooter ) {
    ...
    m_conveyorEntry = m_myTab.add("Conveyor", -.75).withPosition(6, 3).getEntry();
